...
<body>
  <section id="nav-bar">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                <h1>Student Addded successfully</h1>
                <a href="addstudent">Back</a>
            </div>
            <div class="col-md-6">
                <img src="/images/ppq.jpg" alt="Sample Image" class="img-fluid">
            </div>
        </div>
    </div>

    <!-- Link to Bootstrap JS (optional, for features like modals, tooltips, etc.) -->

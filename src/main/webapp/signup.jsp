...
<head>
  ...
  <title>Counseling System Signup</title>
        ...
        <div class="col-md-6">
          <div class="login-container">
            <div class="login-header">
              <h2>Counseling System Signup</h2>
            </div>
            <form >
              ...
              <div class="signup-form-group student-fields">
                  ...
                  <input type="text" id="Id" class="form-control" placeholder="Enter your ID">
                </div>
              <div class="signup-form-group">
              ...
              <div class="signup-form-group">
                ...
                <a href="/newlogin.html" class="btn btn-primary"> Signup </a>
            </form>
          </div>
        </div>
        <br>
